...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(29438660883377618)
...
,p_reference_id=>12769001070084821
,p_version_scn=>42101024421177
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1863829043006704724)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39595991522618441)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39596466847618442)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39596968812618443)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39597459090618444)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39597965694618446)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39605176505618462)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1863829043006704724)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39598444058618447)
,p_plugin_attribute_id=>wwv_flow_imp.id(39597965694618446)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39599080847618448)
,p_plugin_attribute_id=>wwv_flow_imp.id(39597965694618446)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39599625224618449)
,p_plugin_attribute_id=>wwv_flow_imp.id(39597965694618446)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39600237435618451)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39597965694618446)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39600781439618452)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39601235443618453)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39601700642618454)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39602292581618455)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39604503058618460)
,p_plugin_attribute_id=>wwv_flow_imp.id(39602292581618455)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39602710512618457)
,p_plugin_attribute_id=>wwv_flow_imp.id(39602292581618455)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39603331469618458)
,p_plugin_attribute_id=>wwv_flow_imp.id(39602292581618455)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39603994876618459)
,p_plugin_attribute_id=>wwv_flow_imp.id(39602292581618455)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39605176505618462)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39605650575618463)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39606198735618464)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39606677934618465)
,p_plugin_attribute_id=>wwv_flow_imp.id(39606198735618464)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39607205840618466)
,p_plugin_attribute_id=>wwv_flow_imp.id(39606198735618464)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39607868979618467)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1853805156565565410)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1853804565060557953)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1853860188730539832)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1854012406443410603)
,p_plugin_id=>wwv_flow_imp.id(29438660883377618)
