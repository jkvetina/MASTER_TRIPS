...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(29492565085377793)
...
,p_reference_id=>12822910595084998
,p_version_scn=>42101024422522
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2211155032556780308)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2211154477544780307)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39685697004618663)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39686171274618664)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39686627136618666)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39687163141618667)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39687680433618668)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39688173240618669)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39688914470618671)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39687680433618668)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2211155032556780308)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39689419625618672)
,p_plugin_attribute_id=>wwv_flow_imp.id(39688914470618671)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39690059210618673)
,p_plugin_attribute_id=>wwv_flow_imp.id(39688914470618671)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39690645448618675)
,p_plugin_attribute_id=>wwv_flow_imp.id(39688914470618671)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39691236189618676)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39688914470618671)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39691686649618677)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39692122728618678)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39692681081618679)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39693179002618680)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39693629858618681)
,p_plugin_attribute_id=>wwv_flow_imp.id(39693179002618680)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39694252263618683)
,p_plugin_attribute_id=>wwv_flow_imp.id(39693179002618680)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39694864527618684)
,p_plugin_attribute_id=>wwv_flow_imp.id(39693179002618680)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39695434255618685)
,p_plugin_attribute_id=>wwv_flow_imp.id(39693179002618680)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39696019446618686)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(39688173240618669)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2211154477544780307)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39696579452618687)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39697096987618689)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39697528773618690)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39698011047618691)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39698554410618692)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39699080085618693)
,p_plugin_attribute_id=>wwv_flow_imp.id(39698554410618692)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39699651649618694)
,p_plugin_attribute_id=>wwv_flow_imp.id(39698554410618692)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39700252005618696)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39700752958618697)
,p_plugin_attribute_id=>wwv_flow_imp.id(39700252005618696)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39701377650618698)
,p_plugin_attribute_id=>wwv_flow_imp.id(39700252005618696)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39701987551618699)
,p_plugin_attribute_id=>wwv_flow_imp.id(39700252005618696)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39702599088618701)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39703055663618702)
,p_plugin_attribute_id=>wwv_flow_imp.id(39702599088618701)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39703680017618703)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1848732338940748031)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1963143701929011632)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2082174948903316073)
,p_plugin_id=>wwv_flow_imp.id(29492565085377793)
,p_name=>'Avatar Link'
