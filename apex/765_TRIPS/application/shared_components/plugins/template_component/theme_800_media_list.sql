...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(29476026997377740)
...
,p_reference_id=>12806481142084944
,p_version_scn=>42101024422373
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1864029673122556834)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1864029118110556833)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39658449733618598)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39658928194618599)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39659451370618600)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39659929457618602)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39660413312618603)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39659451370618600)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1864029673122556834)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39660935586618604)
,p_plugin_attribute_id=>wwv_flow_imp.id(39660413312618603)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39661525725618605)
,p_plugin_attribute_id=>wwv_flow_imp.id(39660413312618603)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39662183948618606)
,p_plugin_attribute_id=>wwv_flow_imp.id(39660413312618603)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39662783184618608)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(39660413312618603)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39663217192618609)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39663759851618610)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39664236786618611)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39664795694618613)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39665200959618614)
,p_plugin_attribute_id=>wwv_flow_imp.id(39664795694618613)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39665811981618615)
,p_plugin_attribute_id=>wwv_flow_imp.id(39664795694618613)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39666432058618616)
,p_plugin_attribute_id=>wwv_flow_imp.id(39664795694618613)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39667027734618617)
,p_plugin_attribute_id=>wwv_flow_imp.id(39664795694618613)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39667630185618619)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(39659929457618602)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1864029118110556833)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39668152868618620)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39668638131618621)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39669153948618622)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39669657623618623)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39670118974618625)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39670615299618626)
,p_plugin_attribute_id=>wwv_flow_imp.id(39670118974618625)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39671247427618627)
,p_plugin_attribute_id=>wwv_flow_imp.id(39670118974618625)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39671876315618628)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39672347006618629)
,p_plugin_attribute_id=>wwv_flow_imp.id(39671876315618628)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39672936140618630)
,p_plugin_attribute_id=>wwv_flow_imp.id(39671876315618628)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39673573611618632)
,p_plugin_attribute_id=>wwv_flow_imp.id(39671876315618628)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39674114769618633)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39674640012618634)
,p_plugin_attribute_id=>wwv_flow_imp.id(39674114769618633)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39675288327618635)
,p_plugin_attribute_id=>wwv_flow_imp.id(39674114769618633)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39675864466618637)
,p_plugin_attribute_id=>wwv_flow_imp.id(39674114769618633)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39676477316618638)
,p_plugin_attribute_id=>wwv_flow_imp.id(39674114769618633)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39677067710618639)
,p_plugin_attribute_id=>wwv_flow_imp.id(39674114769618633)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39677656261618640)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(39678163641618641)
,p_plugin_attribute_id=>wwv_flow_imp.id(39677656261618640)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(39678727822618643)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1854051465931462611)
,p_plugin_id=>wwv_flow_imp.id(29476026997377740)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
