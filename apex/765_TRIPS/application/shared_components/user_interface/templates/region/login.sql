...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29338989054377382)
,p_layout=>'TABLE'
...
,p_reference_id=>12670376828084579
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39377879517617908)
,p_plug_template_id=>wwv_flow_imp.id(29338989054377382)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39378360184617909)
,p_plug_template_id=>wwv_flow_imp.id(29338989054377382)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39378896148617910)
,p_plug_template_id=>wwv_flow_imp.id(29338989054377382)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39379332395617911)
,p_plug_template_id=>wwv_flow_imp.id(29338989054377382)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39379899843617911)
,p_plug_template_id=>wwv_flow_imp.id(29338989054377382)
,p_name=>'Sub Regions'
