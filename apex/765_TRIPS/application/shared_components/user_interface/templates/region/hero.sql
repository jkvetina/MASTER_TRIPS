...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(29310834936377326)
,p_layout=>'TABLE'
...
,p_reference_id=>12642200983084521
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39306827253617757)
,p_plug_template_id=>wwv_flow_imp.id(29310834936377326)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39307349615617758)
,p_plug_template_id=>wwv_flow_imp.id(29310834936377326)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39307857457617758)
,p_plug_template_id=>wwv_flow_imp.id(29310834936377326)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39308363473617759)
,p_plug_template_id=>wwv_flow_imp.id(29310834936377326)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39308865593617760)
,p_plug_template_id=>wwv_flow_imp.id(29310834936377326)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
