...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29270827910377246)
,p_theme_id=>800
...
,p_reference_id=>12602242729084438
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39203934346617538)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39204479345617539)
,p_page_template_id=>wwv_flow_imp.id(29270827910377246)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39204901957617539)
,p_page_template_id=>wwv_flow_imp.id(29270827910377246)
