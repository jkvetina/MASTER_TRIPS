...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29241173481377192)
,p_theme_id=>800
...
,p_reference_id=>12575914071084389
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39124432642617396)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39124911219617397)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39125449138617397)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39125934330617398)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39126404929617399)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39126930451617400)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39127452107617400)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39127979790617401)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39128420346617402)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39128912413617403)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39129405541617403)
,p_page_template_id=>wwv_flow_imp.id(29241173481377192)
