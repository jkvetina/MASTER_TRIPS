...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29248807796377205)
,p_theme_id=>800
,p_name=>'Login'
...
,p_reference_id=>12583671118084402
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39143563387617429)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39144059656617429)
,p_page_template_id=>wwv_flow_imp.id(29248807796377205)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39144581736617430)
,p_page_template_id=>wwv_flow_imp.id(29248807796377205)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39145006806617431)
,p_page_template_id=>wwv_flow_imp.id(29248807796377205)
,p_name=>'Body Footer'
