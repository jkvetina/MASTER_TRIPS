...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29255444743377218)
,p_theme_id=>800
...
,p_reference_id=>12590243570084415
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39163609837617466)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39164189866617467)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39164690867617468)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39165186512617468)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39165643392617469)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39166145296617470)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39166661044617471)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39167113873617471)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39167655421617472)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39168141023617473)
,p_page_template_id=>wwv_flow_imp.id(29255444743377218)
