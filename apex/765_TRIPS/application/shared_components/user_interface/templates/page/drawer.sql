...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(29238289867377185)
,p_theme_id=>800
,p_name=>'Drawer'
...
,p_reference_id=>12573060678084382
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39114489757617374)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39114941584617375)
,p_page_template_id=>wwv_flow_imp.id(29238289867377185)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(39115309246617376)
,p_page_template_id=>wwv_flow_imp.id(29238289867377185)
